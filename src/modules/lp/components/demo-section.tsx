          ...
          <div className="sticky top-1/2 -translate-y-1/2 z-10 flex justify-center items-center space-x-4">
            <ScrollAnimated animationType="scroll-escala">
              <div className="flex justify-center items-center space-x-4">
                <div className="w-4 h-4 sm:w-6 sm:h-6 bg-purple-600 rounded-full animate-bounce" style={{ animationDelay: '0ms' }}></div>
                <div className="w-4 h-4 sm:w-6 sm:h-6 bg-purple-600 rounded-full animate-bounce" style={{ animationDelay: '150ms' }}></div>
                <div className="w-4 h-4 sm:w-6 sm:h-6 bg-purple-600 rounded-full animate-bounce" style={{ animationDelay: '300ms' }}></div>
              </div>
            </ScrollAnimated>
          </div>
        </div>
